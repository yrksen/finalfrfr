      ...
      <div className="hidden md:block px-4 py-2 w-full max-w-[2400px]">
        <div className="flex justify-center">
          <div className="relative flex items-center">
            {/* Left vertical text */}
            <div className="flex flex-col items-center justify-center mr-12 text-gray-400 font-medium text-lg tracking-wider select-none h-[270px]">
              <span>H</span>
              <span>e</span>
              <span>l</span>
              <span>o</span>
            ...
            {/* Right vertical text */}
            <div className="flex flex-col items-center justify-center ml-12 text-gray-400 font-medium text-lg tracking-wider select-none h-[270px]">
              <span>G</span>
              <span>u</span>
              <span>d</span>
              <span>b</span>
